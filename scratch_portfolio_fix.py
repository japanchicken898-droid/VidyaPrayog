...
old_str = """                          <p className="text-xs text-slate-400 font-bold uppercase tracking-wider mt-2">
                            {profileData.course} ({profileData.year})
                            {profileData.portfolioVisibility.institution && ` â€¢ ${profileData.institution}`}
                          </p>"""

new_str = """                          <div className="flex flex-wrap items-center gap-2 text-xs text-slate-400 font-bold uppercase tracking-wider mt-2">
