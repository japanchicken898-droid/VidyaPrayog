                ...
                <div>
                  ...
                  <div className="space-y-4">
                     <label className="flex items-center gap-3 text-sm text-slate-700 font-medium cursor-pointer group">
                       <input type="checkbox" checked={m3Completed} onChange={handleCompleteSandbox} className="w-4 h-4 rounded text-indigo-600 border-slate-300 focus:ring-indigo-500 transition-colors" />
            ...
            <div className="p-5 sm:p-6 rounded-2xl bg-white border border-slate-200 flex flex-col h-full">
               ...
               <div className="border border-slate-200 rounded-2xl overflow-hidden hover:shadow-md transition-shadow group flex-1 flex flex-col">
                 <div className="relative h-36 shrink-0 overflow-hidden bg-slate-100">
                   ...
                   <span className="absolute bottom-3 left-3 text-[10px] font-extrabold bg-white text-indigo-700 px-2.5 py-1 rounded-lg border border-slate-200 uppercase shadow-sm">Coursera / Google</span>
                 </div>
                 <div className="p-5 bg-white flex flex-col flex-1">
                   <h5 className="font-extrabold text-sm text-slate-900 mb-2 line-clamp-2">Google Cloud Architecture with Kubernetes</h5>
                   <p className="text-xs text-slate-500 font-medium leading-relaxed mb-5 line-clamp-3 flex-1">Master GKE and deploy highly scalable microservices on GCP infrastructure. Features hands-on cluster deployments.</p>
                   <button className="w-full py-2.5 bg-slate-900 text-white rounded-xl text-xs font-bold hover:bg-slate-800 transition-colors shadow-md flex justify-center items-center gap-1.5 active:scale-95 shrink-0 mt-auto">
