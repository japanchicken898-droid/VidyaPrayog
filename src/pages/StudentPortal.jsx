...
const StudentPortal = () => {
  ...
  // Proctored History log state
  const [proctoredHistory, setProctoredHistory] = useState([
    { id: "h-1", title: "Frontend Architecture", date: "OCT 12", score: 92, badge: "Emerald Badge", status: "cert", details: "Frontend Architecture Verified Certificate" },
    { id: "h-2", title: "Algorithms & Data Structures", date: "SEP 28", score: 85, badge: "Emerald Badge", status: "cert", details: "Algorithms & Data Structures Verification" },
    { id: "h-3", title: "Cloud Security Basics", date: "AUG 05", score: 68, badge: "Amber Badge", status: "retake", details: "Diagnostic retake recommendation unlocked." }
  ]);
  ...
  const handleAptitudeSubmit = (report) => {
    ...
    // Add to proctoredHistory log
    setProctoredHistory(prev => [
      {
        id: `h-apt-${Date.now()}`,
  ...
  const renderMainContent = () => {
    ...
    switch (activeTab) {
      case 'Dashboard':
        return <DashboardView onTabChange={handleTabChange} onAction={handleAction} roleMatch={roleMatch} overallMatch={overallMatch} />;
      case 'Skills':
        ...
        <div className="fixed inset-0 bg-slate-900/60 backdrop-blur-sm z-50 flex items-center justify-center p-4 animate-fade-in">
          <div className="bg-white rounded-2xl border border-slate-200 shadow-2xl max-w-md w-full overflow-hidden">
            ...
            <form onSubmit={handleUploadSubmit} className="p-6 space-y-5 text-left">
              ...
              {/* Drag and Drop Zone */}
              <div 
                onClick={() => setUploadedFile({ name: "mongodb-developer-certification.pdf", size: "1.4 MB" })}
